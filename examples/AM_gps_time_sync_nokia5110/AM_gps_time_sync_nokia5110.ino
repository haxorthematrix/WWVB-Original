...
void updateDisplay()
{
	...
	Serial.print("   ");
	if (hh < 10) { Serial.print(0); } // zero pad
	Serial.print(hh); Serial.print(":");
	if (mm < 10) { Serial.print(0); } // zero pad
	Serial.print(mm); Serial.print(":");
	if (ss < 10) { Serial.print(0); } // zero pad
	Serial.println(ss);
	// line 2
	//Serial.print("  DD/MM/YYYY  ");
	Serial.print("  ");
	if (DD < 10) { Serial.print(0); } // zero pad
	Serial.print(DD); Serial.print("/");
	if (MM < 10) { Serial.print(0); } // zero pad
	Serial.print(MM); Serial.print("/");
	if (YY < 80) { Serial.print(20); } // year pad ;)
	else { Serial.print(19); }
	if (YY < 10) { Serial.print(0); } // zero pad
	Serial.println(YY);
	// line 3
	Serial.println("");
	// line 4
	...
	else
	{
		...
		{
		case 1:
			Serial.print("      GPS"); break;
		case 2:
			Serial.print("     DGPS"); break;
		case 3:
			Serial.print("      PPS"); break;
		case 4:
			Serial.print("      RTK"); break;
		case 5:
			Serial.print("float RTK"); break;
		case 6:
			Serial.print("DEAD RECN"); break;
		case 7:
			Serial.print("   MANUAL"); break;
		case 8:
			Serial.print("SIMULATED"); break;
		}
	}
	// nokia5110.display();
}
